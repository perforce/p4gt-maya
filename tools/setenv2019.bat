:: setenv2019.bat
:: Setup environment including for Visual Studio 2019.
:: Sets environment variables used for building P4GT including Visual Studio 2019.
...
@set VSINSTDIR="C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise"
@set OSPLAT=X64
@set SRC=C:\Users\kmackey\perforce\kmackey_p4gt
@set T4TEMP=c:\Temp

:settings
:: Note that this VS 2019 path, file, and parameter is different than for VS 2015.
...
@set JAM=%SRC%\main\jam\bin.ntx64
